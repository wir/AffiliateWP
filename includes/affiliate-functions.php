 ...
 * @since 1.0
 *
 * @param AffWP\Affiliate|int $affiliate Affiliate ID or object.
 ...
 * @since 1.1
 *
 * @param int|AffWP\Affiliate $affiliate Optional. Affiliate ID. Default is the current affiliate.
 ...
 * @since 1.0
 *
 * @param array $data Affiliate data array.
